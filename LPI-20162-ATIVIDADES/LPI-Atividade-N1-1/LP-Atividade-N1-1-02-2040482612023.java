...
class LP_Atividade_N1_1_02_2040482612023 {
    public static void main(String[] args) {
        ...
        Integer aCache = valorCache;
        Integer bCache = valorCache;

        Integer aForaCache = valorForaCache;
        Integer bForaCache = valorForaCache;
        ...
        System.out.println(
                "Fora do Cache (" + valorForaCache + ") -> xForaCache == yForaCache: " + (xForaCache == yForaCache));
        System.out.println("Fora do Cache (" + valorForaCache + ") -> xForaCache.equals(yForaCache): "
